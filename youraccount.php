...
<!doctype html>
    ...
    <section class="mx-auto" style="width:390px; padding-top: 120px">
        ...
        <div class="form-outline mb-3 text-center">
            <input type="label" id="form3Example4" class="mb-3 form-control form-control-lg rounded-pill" placeholder=" <?= $data['username'] ?>"  readonly />
        </div>
        <div class="form-outline mb-3 text-center">
            <input type="label" id="form3Example4" class="mb-3 form-control form-control-lg rounded-pill" placeholder=" <?= $data['password'] ?>"  readonly />
        </div>
        <div class="form-outline mb-3 text-center">
            <input type="label" id="form3Example4" class="mb-3 form-control form-control-lg rounded-pill" placeholder=" <?= $data['level'] ?>"  readonly />
        </div>
        <?php
        }?>
    </section>
